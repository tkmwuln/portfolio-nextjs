...
/**
 * Seed portfolio projects via Prisma.
 * Run: node scripts/seed-projects.cjs
 */
...
// Override DATABASE_URL to use direct connection (not PgBouncer)
...
async function seed() {
  ...
  console.log('\n🎉  Done! Projects are seeded and editable from the CMS dashboard.');
