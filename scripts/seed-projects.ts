/**
 * Portfolio projects seed — run: npx tsx scripts/seed-projects.ts
 * Upserts 6 projects with AI thumbnails into the database via Prisma.
 */
...
async function seed() {
  ...
  console.log('\n🎉  Done! Projects are now in the database — editable from /dashboard/projects');
